            ...
            <ul className="navbar-nav menu w_menu ms-auto me-auto">
                ...
                <ul className="dropdown-menu">
                  <li className="nav-item dropdown submenu active">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="shop-no-sidebar.html" className="nav-link">
                          Shop No Sidebar
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="product-single.html" className="nav-link">
                          Product Details
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item dropdown submenu">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="cart-guest.html" className="nav-link">
                          Cart Guest
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item dropdown submenu">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="checkout-login.html" className="nav-link">
                          Checkout Login
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="checkout-gift.html" className="nav-link">
                          Checkout Gift
                        </a>
                      </li>
                    </ul>
                ...
                <ul className="dropdown-menu">
                  ...
                  <li className="nav-item dropdown submenu">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="order-track.html" className="nav-link">
                          Order Tracking
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="order-confrmation.html" className="nav-link">
                          Thank You Page
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item">
                    <a href="my-ebook-library.html" className="nav-link">
                      Ebook Library
                    </a>
                  </li>
                  ...
                  <li className="nav-item dropdown submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li className="nav-item">
                        <a href="my-list.html" className="nav-link">
                          Book List
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="my-list-details.html" className="nav-link">
                          Book List Details
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="my-list-create.html" className="nav-link">
                          Create Book List
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item dropdown submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li className="nav-item">
                        <a href="my-address.html" className="nav-link">
                          Address Book
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="add-new-address.html" className="nav-link">
                          Add New Address
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item">
                    <a href="my-following-authors.html" className="nav-link">
                      Following Authors
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="my-rating-reviews.html" className="nav-link">
                      Rating & Reviews
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="my-wishlist.html" className="nav-link">
                      Wishlist
                    </a>
                  </li>
                </ul>
                          ...
                          >
                            <div className="d-flex">
                              <ul className="list-unstyled tab_list w_100">
                                ...
                                <li>
                                  <a href="page-banner-style-2.html">
                                    Banner style 02
                                  </a>
                                </li>
                                <li>
                                  <a href="page-banner-style-3.html">
                                    Banner style 03
                                  </a>
                                </li>
                              </ul>
                          ...
                          >
                            <div className="d-flex">
                              <ul className="list-unstyled tab_list">
                                ...
                                <li>
                                  <a href="order-confrmation.html">
                                    Thank You Page
                                  </a>
                                </li>
                                <li>
                                  <a href="my-ebook-library.html">
                                    Ebook Library
                                  </a>
                                </li>
                                <li>
                                  <a href="my-following-authors.html">
                                    Following Authors
                                  </a>
                                </li>
                                <li>
                                  <a href="my-rating-reviews.html">
                                    Rating & Authors
                                  </a>
                                </li>
                              </ul>
                              <ul className="list-unstyled tab_list">
                                ...
                                <li>
                                  <a href="my-list-details.html">
                                    Book List Details
                                  </a>
                                </li>
                                <li>
                                  <a href="my-list-create.html">
                                    Create Book List
                                  </a>
                                </li>
                                <li>
              ...
              <li className="nav-item dropdown submenu">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li className="nav-item">
                    <a href="blog-extend-grid.html" className="nav-link">
                      Extended Grid
                    </a>
                  </li>
                  <li className="nav-item">
              ...
              <ul className="navbar-nav search_cart menu">
                ...
                <li className="nav-item shpping-cart dropdown submenu">
                  ...
                  >
                    ...
                    <span className="num total-cart-count">2</span>
                  </a>
                  <div className="dropdown-menu">
                    ...
                    <div className="cart_f">
                      <div className="cart-pricing">
                        <p className="total">
                          Subtotal :
                          <span className="p-total text-end">
                            $<span className="total-cart-amount"></span>
                          </span>
                        </p>
                      </div>
                      <div className="cart-button text-center">
                        <a
                          href="cart.html"
                          className="btn btn-cart get_btn pink"
                        >
                          View Cart
                        </a>
                        <a
                          href="checkout.html"
                          className="btn btn-cart get_btn dark"
                        >
                          Checkout
                        </a>
                      </div>
