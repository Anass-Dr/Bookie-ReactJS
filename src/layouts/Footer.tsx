const Footer = () => {
  return (
    <footer
      className="bj_footer_area_two bj_footer_area_four"
      style={{ backgroundColor: "#212833" }}
      data-bg-color="#212833"
    >
          ...
          <div className="row">
                ...
                <div className="footer_subscribes">
                  ...
                  <form action="#">
                    <div className="footer_subscribe_form">
                      ...
                      />
                      <button type="submit" className="bj_theme_btn">
                        Subscribe
                      </button>
                    </div>
                  </form>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="f_widget link_widget">
                ...
                <ul className="list-unstyled list">
                  <li>
                    <a href="tel:610383766284">
                      <i className="fa-solid fa-phone-volume"></i>+61 (0) 3 8376
                      6284
                    </a>
                  </li>
                  <li>
                    <a href="mailto:noreply@bookjar.com">
